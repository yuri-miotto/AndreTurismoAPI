...
namespace AndreTurismoAPI.PacoteService.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class PacotesController : ControllerBase
    {
        private readonly AndreTurismoAPIPacoteServiceContext _context;

        public PacotesController(AndreTurismoAPIPacoteServiceContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Pacote>> PostPacote(Pacote pacote)
        {
          if (_context.Pacote == null)
          {
              return Problem("Entity set 'AndreTurismoAPIPacoteServiceContext.Pacote'  is null.");
          }
        ...
        {
            return (_context.Pacote?.Any(e => e.IdPacote == id)).GetValueOrDefault();
        }
    }
}
